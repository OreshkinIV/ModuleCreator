...
gradlePlugin {
    ...
    plugins {
        register("module-creator") {
            description = "Plugin for creating modules with base structure via the terminal. " +
                    "Creates a new module with a clean architecture containing the dagger 2 and retrofit template"
